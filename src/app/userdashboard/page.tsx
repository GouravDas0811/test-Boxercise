...
// function toDate(val: Timestamp | { seconds: number } | Date | undefined | null): Date {
...
//   id: string;
//   userId: string;
//   sessionAt: Timestamp | { seconds: number } | Date;
...
//   "profile" | "schedule" | "upcoming" | "history";
...
//         {[
//           { title: "Lite", price: "₹10999", duration: "1 Month" },
//           { title: "Active", price: "₹13999", duration: "1 Month", badge: "Most Popular" },
//           { title: "Elite", price: "₹15999", duration: "1 Month", badge: "Best Value" },
//           { title: "3-Month", price: "₹33999" },
//           { title: "6-Month", price: "₹64999" },
...
//             className={`cursor-pointer border p-3 rounded-lg ${
//               category === type ? "border-blue-500 bg-gray-800" : "border-gray-700"
//             }`}
//           >
...
//       ) : upcoming.length === 0 ? (
//         <div className="bg-gray-800 p-4 rounded">No upcoming bookings.</div>
//       ) : (
//         upcoming.map((b) => {
//           const sessionDate = toDate(b.sessionAt);
//           return (
...
//     <div className="space-y-4">
//       {bookingsLoading ? (
//         <div className="bg-gray-800 p-4 rounded">Loading history...</div>
//       ) : history.length === 0 ? (
//         <div className="bg-gray-800 p-4 rounded">No past bookings.</div>
//       ) : (
//         history.map((b) => {
//           const sessionDate = toDate(b.sessionAt);
//           return (
